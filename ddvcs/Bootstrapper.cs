...
namespace ddvcs
{
    ...
    {
        public void Register(Container container, String apiKey, String appKey, String baseUri, String folder)
        {
            container.Register<IOutputWriter, OutputWriter>();
            container.Register<IDataDogGateway>(() => new DataDogGateway(apiKey, appKey, baseUri));
